<pre class="rich-diff-level-zero">nobody@github.com:<span class="pl-k rich-diff-level-one">~</span><span class="pl-c rich-diff-level-one"><span class="pl-c">#</span> more</span>
